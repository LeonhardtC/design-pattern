...
public class ComputorBuilder {
	...
	//default值也可以从配置文件里读取，一般是configration从classpath下读取文件
	{
		os = DEFAULT_OS;
	...
	//builder方式可以对参数进行限制
	public ComputorBuilder setOs(String os){
	...
	public ComputorBuilder setOffice(String office) {
	...
	public ComputorBuilder setChat(String chat) {
