...
public class testWoman {
	...
	public static void main(String[] args) {
		//创建一个普通的女人
		IWoman fengjie = new Woman("凤姐",50,80);
		...
		//化妆的女人
		IWoman fengjie1 = new DressUpWoman(fengjie);
		...
		//学习的女人
		IWoman fengjie2 = new LearnWoman(fengjie);
		...
		//有教养的女人
		IWoman fengjie3 = new PoliteWoman(fengjie);
		...
		//有化妆，又学习的女人
		IWoman fengjie4 = new LearnWoman(new DressUpWoman(fengjie));
